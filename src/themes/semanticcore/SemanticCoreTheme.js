 ...
 * @constructor
 */
OO.ui.SemanticCoreTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.SemanticCoreTheme.super.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.SemanticCoreTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.SemanticCoreTheme.prototype.getElementClasses = function ( element ) {
	var
		variants = {
			invert: false,
			progressive: false,
		...
		// Parent method
		classes = OO.ui.SemanticCoreTheme.super.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.SemanticCoreTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.SemanticCoreTheme();
